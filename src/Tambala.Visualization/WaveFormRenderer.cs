...
namespace NAudio.WaveFormRenderer
{
    public class WaveFormRenderer
    {
        ...
        private static Image Render(IPeakProvider peakProvider, WaveFormRendererSettings settings)
        {
            ...
            Bitmap bitmap = new Bitmap(settings.Width, settings.TopHeight + settings.BottomHeight);
            ...
            {
                g.FillRectangle(settings.BackgroundBrush, 0,0,bitmap.Width,bitmap.Height);
